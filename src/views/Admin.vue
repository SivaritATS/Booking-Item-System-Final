<template>
  <div class="admin-page">
    <div class="container">
      <!-- HEADER SECTION แสดงหัวข้อหน้าและคำอธิบาย -->
      ...
      <!-- ADD PRODUCT FORM ฟอร์มสำหรับเพิ่มสินค้าใหม่เข้า Blockchain -->
      ...
      <!-- PRODUCTS LIST แสดงรายการสินค้าทั้งหมดจาก Smart Contract พร้อมฟังก์ชันจัดการสถานะ -->
...
// STATE MANAGEMENT จัดการ state ต่างๆ ของ component
...
// LIFECYCLE HOOKS โหลดข้อมูลเมื่อ component ถูก mount
onMounted(() => {
  loadProducts();
});
</script>
...
<style scoped>
/* MAIN LAYOUT & BACKGROUND พื้นหลังและโครงสร้างหลักของหน้า */
.admin-page {
  min-height: 100vh;
  padding: 2rem 0;
...
/* CARD COMPONENTS การ์ดสำหรับแสดงเนื้อหา */
.form-card,
.products-card {
...
/* BUTTON STYLING สไตล์ของปุ่มต่างๆ */
.submit-button {
...
/* ACTION BUTTONS ปุ่มจัดการสินค้า (Activate/Deactivate) */
.action-buttons {
  display: flex;
  gap: 0.5rem;
  justify-content: center;
...
/* TABLE STYLING ตารางแสดงรายการสินค้า */
.table-wrapper {
  overflow-x: auto;
  border-radius: 1rem;
  border: 1px solid var(--border-color);
...
/* TABLE CELL CONTENT เนื้อหาในแต่ละ cell ของตาราง */
.id-badge {
